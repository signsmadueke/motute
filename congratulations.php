...
<head>
    ...
    <title>Congratulations — Motute</title>
</head>
...
<body class="body">
    ...
    <div id="body">
        <section id="congratulations" class="container">
            <div class="row align-items-center pb-100 pt-100">
                <div class="col-12 pt-30 mb-30">
                    <img src="assets/images/svgs/envelope.svg" class="padding-x2 replaced-svg svg w-100" alt="" style="max-height: 50vh;">
                </div>
                <div class="col-12 text-center">
                    <h3 class="mb-20" style="">Registration Successful</h3>
                    <p class="body-text text-form mb-20">You have successfully registered at Motute.<br>A verification link has been sent to your inbox.<br>Click the verification link to verify your account.</p>
