                ...
                <div class="col-auto align-items-center d-flex hidden-md hidden-sm ml-auto pr-0 pl-0 show" style="">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item account">
                            <a class="nav-link sub-menu-link" href="profile.php">
                                <img class="user ml-0" alt="" src="assets/images/placeholders/dp.jpg">
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a class="align-items-center border-bottom d-flex mb-20 ml-10 mr-10 mt-0 nav-link no-gutters" style="padding: 25px;" href="profile.php">
                                        <div class="col-auto">
