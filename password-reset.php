...
<?php include 'api/v0/php/checkpointv0.php'; ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="body">
    ...
    <div id="body" class="login-form">
        <div class="greeting text-center mb-30">
            ...
            <p class="body-text text-form">Please enter your new password in the form below.</p>
        </div>
...
<script src = "api/v0/js/password-reset.js"></script>
</body>
</html>
